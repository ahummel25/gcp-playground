...
- **Prefix**: `environments/prod` (logical path in bucket)
...
2. Add module block in `infra/environments/prod/main.tf`:
   ```hcl
...
See `infra/modules/cloud-function/README.md` for complete module documentation.
...
### Function Not Found
Ensure you're running Terraform from `infra/environments/prod/` directory.
...
2. Update Terraform configuration in `infra/environments/prod/`
